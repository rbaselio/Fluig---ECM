function validateForm(form) {
	...
	if (numAtividade == 2) {
		...
		if (form.getValue('dir_aprova') != '2'
				&& form.getValue('dir_aprova') != '1') {
			throw "Não foi Selecionado [SIM ou NÃO], campo obrigatório";
		}

		if (form.getValue('dir_aprova') == '2'
				&& form.getValue('dir_jutificativa') == '') {
	...
	if (numAtividade == 4) {
		...
		if (form.getValue('ger_venda2') != '2'
				&& form.getValue('ger_venda2') != '1') {
	...
	if (numAtividade == 9) {
		if (form.getValue('recebe_radio') == '2'
				&& form.getValue('recebe_jutificativa3') == '') {
		...
		if (form.getValue('recebe_radio2') != '1'
				&& form.getValue('recebe_radio2') != '2') {
			throw "Não foi Selecionado [TOTAL NCs , SIM ou NÃO], campo obrigatório";
		}
		if (form.getValue('recebe_radio2') == '1'
				&& form.getValue('recebe_jutificativa2') == '') {
			throw "Informar as [JUSTIFICAVAS], campo obrigatório";
		}
	}
	if (numAtividade == 10) {
		if (form.getValue('fiscal_radio') != '1'
				&& form.getValue('fiscal_radio') != '2'
				&& form.getValue('fiscal_radio') != '3') {
			throw "Não foi Selecionado [CORRIGIDO , SIM , NÃO, REJITADO], campo obrigatório";
		}

	}
	if (numAtividade == 12) {
		if (form.getValue('nf_radio') != '1'
				&& form.getValue('nf_radio') != '2') {
	...
	if (numAtividade == 16) {
		...
		if (form.getValue('ger_radio') != '2'
				&& form.getValue('ger_radio') != '1') {
			throw "Não foi Selecionado [HAVER?? DÉBITO, SIM ou NÃO], campo obrigatório";
		}
	...
	if (numAtividade == 20) {
		...
		if (form.getValue('fince_jutificativa') == '') {
			throw "COBRA AS DESPESAS EST?? VAZIO, campo obrigatório";
		}
	}
}